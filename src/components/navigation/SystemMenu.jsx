    ...
    <NavDropdown title={_systemTitle(location.pathname)} id="system-menu-dropdown">
      ...
      <HideOnCloud>
        <IfPermitted permissions={['authentication:edit']} anyPermissions>
          <NavigationLink path={Routes.SYSTEM.AUTHENTICATION.BACKENDS.ACTIVE} description="身份验证" />
        </IfPermitted>
      </HideOnCloud>
      ...
      <IfPermitted permissions={['inputs:edit']}>
        <NavigationLink path={Routes.SYSTEM.LOOKUPTABLES.OVERVIEW} description="查阅表格" />
      </IfPermitted>
